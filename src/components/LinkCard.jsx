...
export default function LinkCard({url,fetchUrls}) {
  ...
  return (
    <div className='flex flex-col md:flex-row gap-5 border p-4 bg-gray-900 rounded-lg'>
      ...
      <span className='text-xl text-blue-400 font-bold hover:underline cursor-pointer'>{import.meta.env.VITE_WEB_URL}/{url?.custom_url ? url?.custom_url : url.short_url}</span>
